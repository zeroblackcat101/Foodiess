...
public class ObjectDetectorClass {
    ...
    public ObjectDetectorClass(AssetManager assetManager, String modelPath, String labelPath, int inputSize) throws IOException{
        ...
        options.setNumThreads(8); // set it according to your phone
        // loading model
    ...
    private ByteBuffer convertBitmapToByteBuffer(Bitmap bitmap) {
        ...
        if(quant==0){
            byteBuffer=ByteBuffer.allocateDirect(1*size_images*size_images*3*1);
        }
        else {
